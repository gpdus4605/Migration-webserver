...
docker-compose --env-file /home/ubuntu/onpremise-webservice/.env -f /home/ubuntu/onpremise-webservice/docker-compose.yml -p onpremise exec api flask db upgrade
